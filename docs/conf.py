# -*- coding: utf-8 -*-
#
# ver1_0 documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('./../ver1_0/'))
sys.path.insert(0, os.path.abspath('./../ver1_0/openassembly'))

# Set up the Django settings/environment
from django.core.management import setup_environ
from openassembly import settings
